<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\xampp\htdocs\tenflyer\public/../application/admin\view\system\add_menu.html";i:1538730720;}*/ ?>
...
<div class="pageContent">
    ...
    <form method="post" action="<?php echo url('system/savemenu'); ?>" class="pageForm required-validate" onsubmit="return validateCallback(this)">
        ...
        <div class="pageFormContent nowrap" layoutH="97" style="padding-left:50px;">

            <dl>
                <dt>菜单名称：</dt>
                <dd>
                    <input type="text" name="name" maxlength="30" class="required" size="30"/>
            ...
            <dl>
                <dt>菜单状态：</dt>
                <dd>
                    <select class="required" name="status" style="width:80px;">
            ...
            <dl>
                <dt>菜单排序：</dt>
                <dd>
                    <input type="text" name="sort" maxlength="30" class="required" alt="排序号" size="8"/>
                    <span class="info"></span>
                </dd>
            </dl>
            <dl>
                <dt>备注：</dt>
                <dd><textarea name="remark" cols="40" rows="4" class="textInput"></textarea></dd>
            </dl>
        </div>
        <div class="formBar">
            <ul>
