<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\phpStudy\WWW\tenflyer\public/../application/admin\view\login\login.html";i:1536379567;}*/ ?>
...
<div id="login">
	<div id="login_header">
		<h1 class="login_logo">
			<a href="/tenflyer/public/admin/login"><img src="/tenflyer/public/static/dwz/themes/default/images/logo.png" /></a>
		</h1>
	...
	<div id="login_footer">
		Copyright &copy; 2018 <?php echo \think\Config::get('COMPANY'); ?> Inc. All Rights Reserved.
	</div>
</div>
